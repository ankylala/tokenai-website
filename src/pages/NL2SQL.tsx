  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <main>
        <section className="relative py-20 bg-gradient-to-b from-slate-900 via-purple-900/10 to-slate-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
              ...
              <p className="text-purple-400 text-sm mb-8">用自然语言查询企业数据</p>
              ...
              <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-2xl p-8 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <div className="flex gap-6">
                  <div className="text-center"><div className="text-4xl font-bold text-white">98%+</div><div className="text-sm text-purple-200 mt-1">查询准确率</div></div>
                  <div className="text-center"><div className="text-4xl font-bold text-white">&lt;3s</div><div className="text-sm text-purple-200 mt-1">平均响应时间</div></div>
                  <div className="text-center"><div className="text-4xl font-bold text-white">300+</div><div className="text-sm text-purple-200 mt-1">支持数据库</div></div>
                </div>
              </div>
            </motion.div>
          </div>
                ...
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                  <div className="relative bg-slate-800/50 rounded-xl p-5 border border-white/10">
                    ...
                    <div className="bg-slate-900/50 rounded-lg p-2">
                      <code className="text-purple-300 text-xs font-mono">{step.example}</code>
                    </div>
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="bg-slate-800/50 rounded-xl p-6 border border-white/10">
                ...
                <div className="bg-slate-900 rounded-lg p-3">
                  <code className="text-purple-300 text-xs font-mono">CREATE TABLE SYSTEM.WG4_TQ_YH (cust_id NUMBER, cust_name VARCHAR2(255), ...);</code>
                </div>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="bg-slate-800/50 rounded-xl p-6 border border-white/10">
                ...
                <div className="bg-slate-900 rounded-lg p-3">
                  <code className="text-purple-300 text-xs font-mono">Q: 查询某用户欠费记录<br/>SELECT COUNT(*) FROM table WHERE cust_id = ?</code>
                </div>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-slate-800/50 rounded-xl p-6 border border-white/10">
                ...
                <div className="bg-slate-900 rounded-lg p-3">
                  <code className="text-purple-300 text-xs font-mono">故障报修类型：高压故障、低压故障、电能质量故障等六类...</code>
                </div>
              </motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="bg-slate-800/50 rounded-xl p-6 border border-white/10">
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <span className="px-2 py-1 bg-blue-500/20 text-purple-400 text-xs rounded">持续优化</span>
                </div>
              </motion.div>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {advantages.map((adv, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-blue-500/10 rounded-xl p-6 border border-purple-500/20 text-center">
                  <adv.icon className="w-10 h-10 text-purple-400 mx-auto mb-4" />
        ...
        <section className="py-20 bg-slate-950">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="bg-slate-800/50 rounded-xl p-6 border border-white/10">
                <GitBranch className="w-10 h-10 text-purple-400 mb-4" />
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {dbSupport.map((db, i) => (
                <motion.div key={i} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: i * 0.05 }} className="bg-slate-800/50 rounded-lg p-4 border border-white/10 flex items-center justify-between">
                  ...
                  <span className="text-purple-400 text-sm">{db.version}</span>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {deployOptions.map((opt, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="bg-slate-800/50 rounded-xl p-6 border border-white/10 hover:border-purple-500/30 transition-all">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="text-white font-bold">{opt.title}</h3>
                    <span className="px-2 py-0.5 bg-blue-500/20 text-purple-400 text-xs rounded-full">{opt.badge}</span>
                  </div>
        ...
        <section className="py-20 bg-gradient-to-r from-purple-900/40 to-pink-900/40">
